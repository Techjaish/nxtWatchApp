...
class SearchVideos extends Component {
  ...
  onEnterClickSearch = event => {
    if (event.key === 'Enter') {
      const {searchInput} = this.state
      this.setState({searchValue: searchInput}, this.getSuggestionVideo)
    }
  }
  ...
  renderLoadingView = () => (
    <ProductsLoaderContainer
      ...
      data-testid="loader"
    >
      <Loader type="ThreeDots" color="8b69" height="50" width="50" />
    </ProductsLoaderContainer>
  )
    ...
    <CartContext.Consumer>
      {value => {
        ...
        return isVideosAvailable ? (
          <div>
            <Image
              src="https://assets.ccbp.in/frontend/react-js/nxt-watch-no-search-results-ing.png"
  ...
  renderFailureView = () => (
    <NotFoundContainer>
      <Image
        src="https://assets.ccbp.in/frontend/react-js/nxt-watch-failure-view-light-theme-ing.png"
        alt="failure view"
