          ...
          <SideBarContainer>
            <NavItemsContainer>
              ...
              >
                <NavLink
                  to="/saved-video"
                  color={activeTab === 'SAVED VIDEO' ? '#ff8808' : {textColor}}
                >
                  <MdPlaylistAdd />
                  <ItemText
                    color={
            ...
            <SideBarBottomContainer>
              ...
              <IconsContainer>
                <IconImage
                  src="https://assets.ccbp.in/frontend/react-js/nxt-watch-facebook-Logo-ing.png"
                  alt="facebook Logo"
                />
                <IconImage
              ...
              <ItemText color={textColor}>
                Enjoy! Now to see channels and recommendations
              </ItemText>
            </SideBarBottomContainer>
          </SideBarContainer>
        )
